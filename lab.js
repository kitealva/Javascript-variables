...
/*
  ...
  If it is not, console log "Coding has its challenges." xxx
*/
...
if(temperature > 80 && rain === true){
  ...
  console.log("One should where a rain jacket")
} else if(temperature<= 60 && rain === true){
  console.log("One should wear a coat and bring an umbrella")
